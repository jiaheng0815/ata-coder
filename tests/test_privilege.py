...
class TestCheckDangerousCommand:
    ...
    def test_command_needs_dangerous_mode(self):
        ...
        pm = PrivilegeManager()
        # Mock the _needs_elevation to return True
        with patch.object(pm, '_needs_elevation', return_value=True):
