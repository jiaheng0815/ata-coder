...
# Skill-local utility module (skill dir is on sys.path during handler load)
from weather_utils import load_city_coords, format_weather_response, GEO_URL, WEATHER_URL
